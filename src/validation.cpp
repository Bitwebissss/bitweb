                                  ...
                                  std::map<Wtxid, MempoolAcceptResult>& results)
{
    ...
    for (Workspace& ws : workspaces) {
        ...
        // BACKPORT (upstream bitcoin/bitcoin commit ac9aa71b7f; not in official 30.x/31.x
        // as of 2026-07-05): DO NOT DROP ON NEXT UPSTREAM MERGE/REBASE.
        ...
        // transactions (which may implicitly depend on the failed one) in the mempool - a
        // potential mempool-consistency invariant violation. This is defensive
